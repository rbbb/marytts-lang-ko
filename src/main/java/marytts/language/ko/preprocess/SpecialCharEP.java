...
public class SpecialCharEP extends ExpansionPattern
{
    ...
    private Map<String, SCEntry> createSpecialCharNames()
    {
        ...
        m.put(",",  new SCEntry("쉼표", false, false));
        m.put("\\", new SCEntry("반대쪽슬래시", true,  true));
        m.put("!",  new SCEntry("느낌표", false, false));
        m.put("#",  new SCEntry("샤프", true,  true));
        m.put("$",  new SCEntry("달러표시", false, true));
        m.put("%",  new SCEntry("퍼센트", false, true));
        m.put("&",  new SCEntry("앤드", true,  true));
        m.put("'",  new SCEntry("아포스트로피",                 true,  false));
        m.put("*",  new SCEntry("별표", true,  true));
        m.put("+",  new SCEntry("플러스", true,  true));
        m.put("-",  new SCEntry("마이너스", false, false));
        m.put("/",  new SCEntry("슬래시", true,  false));
        m.put("=",  new SCEntry("이콜", true,  true));
        m.put("?",  new SCEntry("물음표", true,  false));
        m.put("^",  new SCEntry("탈자기호",                      true,  false));
        m.put("_",  new SCEntry("아래하이픈", true,  false));
        m.put("`",  new SCEntry("작은 따옴표", true,  false));
        m.put("{",  new SCEntry("중괄호", true,  false));
        m.put("|",  new SCEntry("수직선 ",        true,  false));
        m.put("}",  new SCEntry("중괄호", true,  false));
        m.put("~",  new SCEntry("물결무늬", true,  true));
        m.put("(",  new SCEntry("소괄호", true,  false)); 
        m.put(")",  new SCEntry("소괄호", true,  false));
        m.put("[",  new SCEntry("대괄호", true,  false));
        m.put("]",  new SCEntry("대괄호", true,  false));
        m.put("@",  new SCEntry("골뱅이", false, true));
        m.put(":",  new SCEntry("쌍점", false, false));
        m.put(";",  new SCEntry("세미콜론", true,  false));
        m.put("\"", new SCEntry("큰 따옴표", true,  false));
        m.put("<",  new SCEntry("부등기호", true,  true));
        m.put(">",  new SCEntry("부등기호", true,  true));
        m.put(".",  new SCEntry("점", false, false));
        return m;
    };
